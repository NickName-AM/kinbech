...
urlpatterns = [
    ...
    path('product/comment/delete/<int:c_id>', views.delete_comment, name='products-comment-delete'),
    ...
    path('product/unbookmark/<int:p_id>', views.unbookmark, name='products-unbookmark'),
